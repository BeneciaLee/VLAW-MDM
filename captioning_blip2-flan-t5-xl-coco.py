...
def main(args):
    ...
    gen_kwargs = {"max_length": max_length, "num_beams": num_beams, "num_return_sequences":num_return_sequences, "min_length":min_length}

    processor = Blip2Processor.from_pretrained("../pretrained_models/blip2-flan-t5-xl-coco", local_files_only=True)
    model = Blip2ForConditionalGeneration.from_pretrained("../pretrained_models/blip2-flan-t5-xl-coco",
    ...
    with torch.no_grad():
        for p_v, image_hashes in yfcc_image_dataloader:
